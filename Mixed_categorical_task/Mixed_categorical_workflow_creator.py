...
def workflow_creator(input_dict, opt_method):
    ...
    if opt_method=='skopt_gp':
        firetask1 = MixedCategoricalTask()
        firetask2 = SKOptimizeTask(func='Mixed_categorical_workflow_creator.workflow_creator', min_or_max="max")
    elif opt_method=='dummy':
        firetask1 = MixedCategoricalTask()
        firetask2 = DummyOptimizeTask(func='Mixed_categorical_workflow_creator.workflow_creator')
    else:
