    ...
    if func is not None:
        ...
        with open(filename, 'w') as f:
            try:
                ...
                f.write("    spec0 = {'_x_opt':x, '_priority':2}\n")
                f.write("    spec1 = {'_x_opt':x, '_priority':1}\n")
                f.write("    fw0 = Firework([pt], spec=spec0, name='PyTaskFW')\n")
                f.write("    fw1 = Firework([ot], spec=spec1, "
                        "name='RocketsledFW')\n")
