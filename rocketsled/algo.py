...
"""
Custom algorithms compatible with OptTask when used as predictors. Most 
...
predictor='rocketsled.algo.stochastic_rbf'

or 

predictor='my/path/to/algo.stochastic_rbf
