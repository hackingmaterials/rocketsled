...
def workflow_creator(input_dict, opt_method):
    ...
    if opt_method=='skopt_gp':
        firetask1 = CategoricalTask()
        firetask2 = SKOptimizeTask(func='Categorical_workflow_creator.workflow_creator', min_or_max="max")
    elif opt_method=='dummy':
        firetask1 = CategoricalTask()
        firetask2 = DummyOptimizeTask(func='Categorical_workflow_creator.workflow_creator')
    else:
